...
# Initialization
# Connection string for Ubuntu = /dev/ttyUSB0 | Windows = COMXX | MAVProxy = 127.0.0.1:14550.
connection_string =  "COM10" #"/dev/ttyUSB0"
gps_save = {} # Create empty GPS coordinate dictionary.
